...
import { X, ShieldCheck, Check, Layers, Lock, Cpu, Server, Key, Award } from 'lucide-react';
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                Razorpay AI Buildathon — Track 01 Standard Architecture
              </p>
            </div>
          </div>
          <button 
...
[Intent Mandate] (Set once: budget ceiling ₹3000, size 9, ETA, max_retries)
   │ (Bounds downstream actions)
   ▼
[Buyer Agent Orchestrator] ──► Query Catalogs & Multi-Factor Scoring
   │
   ▼
...
[Confirmation & Immutable Audit Trail]`}
            </div>
          </div>
          ...
          <div className="glass-panel" style={{ padding: '16px', background: 'rgba(15, 23, 42, 0.7)' }}>
            <h4 style={{ fontSize: '0.9rem', fontWeight: 700, color: '#ffffff', marginBottom: '6px', display: 'flex', alignItems: 'center', gap: '6px' }}>
